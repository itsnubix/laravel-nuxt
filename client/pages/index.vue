...
<template>
  <div
    class="items-top relative flex min-h-screen justify-center py-4 sm:items-center sm:pt-0"
  >
    ...
    <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div class="p-6">
            <div class="flex items-center">
              <BookOpenIcon class="h-8 w-8 text-gray-500" />
          ...
          <div class="border-t border-gray-200 p-6 md:border-t-0 md:border-l">
            <div class="flex items-center">
              <CameraIcon class="h-8 w-8 text-gray-500" />
              <div class="ml-4 text-lg font-semibold leading-7">
                <a href="https://laracasts.com" class="text-gray-900 underline">
                  Laracasts
                </a>
              </div>
            </div>
          ...
          <div class="border-t border-gray-200 p-6 md:border-l">
            <div class="flex items-center">
              <GlobeAsiaAustraliaIcon class="h-8 w-8 text-gray-500" />
              <div class="ml-4 text-lg font-semibold leading-7 text-gray-900">
                Vibrant Ecosystem
              </div>
            </div>
      ...
      <div class="mt-4 flex justify-center sm:items-center sm:justify-between">
        <div class="text-center text-sm text-gray-500 sm:text-left">
          <div class="flex items-center">
            <ShoppingCartIcon class="-mt-px h-5 w-5 text-gray-400" />

            <a href="https://laravel.bigcartel.com" class="ml-1 underline">
              Shop
            </a>

            <HeartIcon class="ml-4 -mt-px h-5 w-5 text-gray-400" />
